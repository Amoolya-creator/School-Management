...
function Manpower_under_me_fx() {
    ...
    for (var Individual in Manpower) {
        if (ME == Manpower[Individual].Recruiter) Manpower_under_me.push(Individual);
    }
    ...
    Manpower_under_me.forEach((e) => {
        if (Manpower[e].Status == "Available") {
            ...
            <td><input readonly value="' + Manpower[e].UserID + '"></td>\
            <td>' + Manpower[e].Post + '</td>\
            <td><input value="5A" maxlength=3 size=3></td>\
            <td><input value="5A" maxlength=3 size=3></td>\
            <td><input value="5A" maxlength=3 size=3></td>\
            <td><input value="5A" maxlength=3 size=3></td>\
            <td><input value="5A" maxlength=3 size=3></td>\
            <td><input value="5A" maxlength=3 size=3></td>\
            <td><input value="5A" maxlength=3 size=3></td>\
            <td><input value="5A" maxlength=3 size=3></td></tr>'         
        }        
    })
    $("#timetable").html(tt)
}
